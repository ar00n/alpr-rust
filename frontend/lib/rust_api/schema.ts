...
export const exportAllowListCsv = (
 ...
 options?: SecondParameter<typeof customAxios>,signal?: AbortSignal
      ...
      {url: `/api/allow-list/export`, method: 'GET', signal
    },
      options);
    }
...
export const getExportAllowListCsvQueryKey = () => {
    return [
    `/api/allow-list/export`
    ] as const;
    }


export const getExportAllowListCsvQueryOptions = <TData = Awaited<ReturnType<typeof exportAllowListCsv>>, TError = AppErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof exportAllowListCsv>>, TError, TData>>, request?: SecondParameter<typeof customAxios>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getExportAllowListCsvQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof exportAllowListCsv>>> = ({ signal }) => exportAllowListCsv(requestOptions, signal);





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof exportAllowListCsv>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ExportAllowListCsvQueryResult = NonNullable<Awaited<ReturnType<typeof exportAllowListCsv>>>
export type ExportAllowListCsvQueryError = AppErrorResponse


export function useExportAllowListCsv<TData = Awaited<ReturnType<typeof exportAllowListCsv>>, TError = AppErrorResponse>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof exportAllowListCsv>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof exportAllowListCsv>>,
          TError,
          Awaited<ReturnType<typeof exportAllowListCsv>>
        > , 'initialData'
      >, request?: SecondParameter<typeof customAxios>}
...
export function useExportAllowListCsv<TData = Awaited<ReturnType<typeof exportAllowListCsv>>, TError = AppErrorResponse>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof exportAllowListCsv>>, TError, TData>>, request?: SecondParameter<typeof customAxios>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useExportAllowListCsv<TData = Awaited<ReturnType<typeof exportAllowListCsv>>, TError = AppErrorResponse>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getExportAllowListCsvQueryOptions(options)
...
export const importAllowListCsv = (
    importAllowListCsvBody: string,
 options?: SecondParameter<typeof customAxios>,signal?: AbortSignal
) => {


      return customAxios<void>(
      {url: `/api/allow-list/import`, method: 'POST',
      headers: {'Content-Type': 'text/csv', },
      data: importAllowListCsvBody, signal
    },
      options);
    }
...
export const getImportAllowListCsvMutationOptions = <TError = AppErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof importAllowListCsv>>, TError,{data: string}, TContext>, request?: SecondParameter<typeof customAxios>}
): UseMutationOptions<Awaited<ReturnType<typeof importAllowListCsv>>, TError,{data: string}, TContext> => {

const mutationKey = ['importAllowListCsv'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof importAllowListCsv>>, {data: string}> = (props) => {
          const {data} = props ?? {};

          return  importAllowListCsv(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ImportAllowListCsvMutationResult = NonNullable<Awaited<ReturnType<typeof importAllowListCsv>>>
    export type ImportAllowListCsvMutationBody = string
    export type ImportAllowListCsvMutationError = AppErrorResponse

    export const useImportAllowListCsv = <TError = AppErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof importAllowListCsv>>, TError,{data: string}, TContext>, request?: SecondParameter<typeof customAxios>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof importAllowListCsv>>,
        TError,
        {data: string},
        TContext
      > => {
      return useMutation(getImportAllowListCsvMutationOptions(options), queryClient);
    }
